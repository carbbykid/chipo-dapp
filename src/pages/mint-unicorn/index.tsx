...
import EggUnicorn from "components/page/mint-unicorn/EggUnicorn";
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="flex-1 relative z-10 flex flex-col-reverse lg:flex-col">
          <div>
          ...
          <div>
            <p className="text-base md:text-[25px] mb-[31px]">
            ...
            />
            <p className="text-base md:text-[25px] mb-4 text-center">
              MAXIMUM QUANTITY 10
            </p>
            ...
            {mounted && isConnected && (
              <>
                <button
                  ...
                  onClick={() => mintToken?.()}
                  className="button text-xl md:text-4xl border-[2px] mb-4 rounded-[15px] py-[10px] px-[20px] mx-auto my-0 block text-center"
                >
                ...
                {approved && (
                  <button
                    ...
                    onClick={() => mintNFT?.()}
                    className="button text-xl md:text-4xl border-[2px] rounded-[15px] py-[10px] px-[20px] mx-auto my-0 block text-center"
                  >
                ...
                {!approved && (
                  <button
                    disabled={
                      !approval || isApprovalLoading || isApprovalSuccess
                    }
