...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`aqua-sidebar border-[#d581ab] border-t-2 border-r-2 rounded-r-[25px]  ease-in duration-300 absolute sm:relative bg-[#6c5454] md:bg-transparent h-full md:h-auto w-[345px] z-50 ${
